...
public class CityView extends Div implements BeforeEnterObserver {
    ...
    public CityView(CityService cityService, CountryService countryService) {
        ...
        grid.addColumn("cityId").setAutoWidth(true).setSortable(true).setResizable(true);
        grid.addColumn("cityName").setAutoWidth(true).setSortable(true).setResizable(true);
        grid.addColumn(city -> city.getCountry() != null ? city.getCountry().getCountryName(): "N/A")
                .setHeader("Country").setAutoWidth(true).setSortable(true).setResizable(true);
        ...
        print.addClickListener(e -> {
            ...
            try {
                ...
                List<CityReportBean> reportBeans = cities.stream()
                        .map(CityReportBean::new)
                        .collect(Collectors.toList());
                System.out.println("Cities para el reporte " + reportBeans.size());
                ...
                try (FileOutputStream fos = new FileOutputStream("city_report_debug.pdf")) {
                    pdfOutputStream.writeTo(fos);
                    System.out.println("PDF grabado a  city_report_debug.pdf.");
                ...
                String reportFileName = "city_report_" + System.currentTimeMillis() + ".pdf";
